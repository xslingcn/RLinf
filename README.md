...
<h1 align="center">
  <sub>RLinf: Reinforcement Learning Infrastructure for Embodied AI</sub>
</h1>

RLinf is a flexible and scalable open-source RL infrastructure designed for Embodied AI. The 'inf' in RLinf stands for `Infrastructure`, highlighting its role as a robust backbone for next-generation training. It also stands for `Infinite`, symbolizing the system’s support for open-ended learning, continuous generalization, and limitless possibilities in intelligence development.
...
- [2026/03] 🔥 RLinf includes a maintained local YAM + LeRobot π0.5 inference runbook. Repo: [LOCAL_YAM_LEROBOT_PI05_RUNBOOK](examples/embodiment/LOCAL_YAM_LEROBOT_PI05_RUNBOOK.md).
...
<table style="width: 100%; table-layout: auto; border-collapse: collapse;">
  ...
  <tbody valign="top">
    <tr>
      ...
      <td>
        <ul style="margin-left: 0; padding-left: 16px;">
          <li><a href="examples/embodiment/LOCAL_YAM_LEROBOT_PI05_RUNBOOK.md">YAM + LeRobot π0.5</a> ✅</li>
          <li>More...</li>
        </ul>
      </td>
      <td>
        <ul style="margin-left: 0; padding-left: 16px;">
          <li><b>VLA</b></li>
          <ul>
            <li><a href="examples/embodiment/LOCAL_YAM_LEROBOT_PI05_RUNBOOK.md">LeRobot π0.5</a> ✅</li>
...
**Run local robot inference:** For the maintained local real-robot flow in this worktree, use the [YAM + LeRobot π0.5 runbook](examples/embodiment/LOCAL_YAM_LEROBOT_PI05_RUNBOOK.md).
...
# CI Test Status
RLinf has comprehensive CI tests for both the core components (via unit tests) and end-to-end embodied RL training workflows.
