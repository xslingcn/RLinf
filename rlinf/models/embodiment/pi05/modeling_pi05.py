...
from rlinf.models.embodiment.pi05.configuration_pi05 import PI05Config, PreTrainedConfig
from rlinf.vendor.transformers_pi05.models.gemma import modeling_gemma
from rlinf.vendor.transformers_pi05.models.gemma.configuration_gemma import (
    GemmaConfig as HFGemmaConfig,
)
from rlinf.vendor.transformers_pi05.models.gemma.modeling_gemma import GemmaForCausalLM
from rlinf.vendor.transformers_pi05.models.paligemma.configuration_paligemma import (
    PaliGemmaConfig as HFPaliGemmaConfig,
)
from rlinf.vendor.transformers_pi05.models.paligemma.modeling_paligemma import (
    PaliGemmaForConditionalGeneration,
)
from rlinf.vendor.transformers_pi05.models.siglip import check
...
RTCProcessor = Any
ACTION = "action"
OBS_LANGUAGE_ATTENTION_MASK = "observation.tokenized_prompt_mask"
OBS_LANGUAGE_TOKENS = "observation.tokenized_prompt"
...
def _restore_missing_tied_weight_keys(
    ...
    for primary_key, tied_key in tied_weight_pairs:
        ...
        source_key, target_key = (
            (primary_key, tied_key) if primary_present else (tied_key, primary_key)
        )
...
class PaliGemmaWithExpertModel(
    ...
    def __init__(
        ...
        vlm_config_hf = HFPaliGemmaConfig()
        ...
        action_expert_config_hf = HFGemmaConfig(
    ...
    def from_pretrained(
        ...
        **kwargs,
        ...
        try:
            ...
            remapped_state_dict, restored_tied_keys = _restore_missing_tied_weight_keys(
                remapped_state_dict
            )
